...
team_name = 'Carson Scotts Team' # Only 10 chars displayed.
strategy_name = 'collude and then do whatever they did in that round'
strategy_description = 'using both players histories.?'
